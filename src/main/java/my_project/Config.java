...
public class Config {
    ...
    public final static int WINDOW_WIDTH = (240*6);
    public final static int WINDOW_HEIGHT = (160*6)+28;   // Effektive Höhe ist etwa 29 Pixel geringer (Titelleiste wird mitgezählt)
